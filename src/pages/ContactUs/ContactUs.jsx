  ...
  return (
    <div className="m-auto ">
      ...
      <div>
          ...
          <div className="row row-cols-1 row-cols-md-2 row-cols-lg-3 g-4 text-light">
            <div className="col text-center h-100">
              ...
              <p className="card-text">
                State Highway 5, Govind Nagar, Andaman and Nicobar Islands
                744211
              </p>
            </div>
            <div className="col text-center h-100">
        ...
        <div
          style={{
            backgroundImage: `url(${'https://www.andamancab.in/assets/img/bgs/bg-about-us.png'})`,
          }}
